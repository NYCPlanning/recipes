...
py_recipes = ['dpr_capitalprojects',
                'bpl_libraries','dcp_sfpsd', 'doe_lcgms', 'doe_universalprek', 'foodbankny_foodbanks', 
                'moeo_socialservicesiteloactions','nycdoc_corrections', 'nypl_libraries', 'nysdoccs_corrections']
